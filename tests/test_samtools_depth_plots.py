...
#         expected_depth_lines_fp = f"{self.gs_qc_dir}/" \
#                                   f"2021-02-08-ARTIC-depth_lineplot.pdf"
...
#         out_depth_violin_fp = f"{self.test_temp_dir}/" \
#                               f"temp_test_depth_violin.pdf"
...
#             actual_lines = Image(filename=out_depth_lines_fp,
#                                  resolution=150)
...
#
#             actual_violin = Image(filename=out_depth_violin_fp,
#                                   resolution=150)
