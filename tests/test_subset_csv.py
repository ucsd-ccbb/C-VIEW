...
class SubsetCsvTest(FileTestCase):
    ...
    def test_filter_csv_accepted_cons_fnames(self):
    ...
    def test_filter_csv_accepted_cons_fnames_w_dir(self):
    ...
    def test_filter_csv_indel_flagged_cons_fnames(self):
    ...
    def test_filter_csv_indel_flagged_cons_fnames_w_dir(self):
